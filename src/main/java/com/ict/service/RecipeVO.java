...
public class RecipeVO {
	...
	private String m_idx, regdate, lastedit, hit, likeit, writer;
	...
	public String getRecipe_quant() {
		return recipe_quant;
	}
	public void setRecipe_quant(String recipe_quant) {
		this.recipe_quant = recipe_quant;
	}
