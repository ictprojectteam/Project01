...
public class EventVO {
	...
	public String getE_public() {
		return e_public;
	}
	public void setE_public(String e_public) {
		this.e_public = e_public;
	}
	public String getE_banner() {
		return e_banner;
	}
	public void setE_banner(String e_banner) {
		this.e_banner = e_banner;
	}
